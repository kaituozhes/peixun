      ...
      myNav[i].className="u-cursor active b-group-text1";   
            ...
            <div class="a-right">
              <div class="b-group-border2">
                ...
                <h4 class="a-head b-group-text2 b-group-border3">成绩查询<span>身份证号：<?php echo ($student["ids"]); ?></span><span>姓名：<?php echo ($student["realname"]); ?></span></h4>

				<div class="cjcx_td">
          
          <?php if(is_array($datas)): $i = 0; $__LIST__ = $datas;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><h3><span>培训机构：<?php echo ($vo["agencyname"]); ?></span></h3>
					<div class="td">
						<p class="sec "><span class="blue">课程名</span><span><?php echo ($vo["subject_name"]); ?></span></p>
						<p><span class="blue">阶段</span><span>
            <?php if($vo[stage] == 0): ?>暂无进度<?php endif; ?>
            <?php if($vo[stage] == 1): ?>课程学习<?php endif; ?>
            <?php if($vo[stage] == 2): ?>考试准备<?php endif; ?>
            <?php if($vo[stage] == 3): ?>考试完成 | <?php echo ($vo[fen]); ?> 分<?php endif; ?>
