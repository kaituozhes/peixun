          ...
          <div class="mianbiaoxie d-legacy">
            <div class="b-macros-breadcrumb b-breadcrumb">
              <ol class="breadcrumb">
                ...
                <li>
                  <a class="u-cursor" href="<?php echo ($categroy["tid"]); ?>"><?php echo ($categroy["catename"]); ?></a></li>
              </ol>
            </div>
          </div>
              ...
              <div class="a-top u-mg-b-10">
                <h4 class="a-head b-group-border3">
                  <div class="s-components-text s-text1 " style="text-align:inherit; ">
                    <span style="font-size:18px; font-family:microsoft yahei; color:rgb(16, 70, 128); line-height:2.0; padding-top:0px; font-weight:bold; display:block; padding-left:0px; " id="id_fa7f9c0b7db4df6659428728"><a href="/index.php/Home/listarticle/indexabout/id/95.html">关于我们</a></span></div>
                </h4>
                <div class="">
