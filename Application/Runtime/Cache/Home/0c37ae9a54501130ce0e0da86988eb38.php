            ...
            <div class="b-macros-breadcrumb b-breadcrumb">
              <ol class="breadcrumb">
                <li>
                  ...
                  <li>
                  <a class="u-cursor" href="/index.php/Home/prove/index.html">证书查询</a></li>
          ...
          <div class="a-container">
            ...
            <div class="a-right">
              <div class="b-group-border2">
                <h4 class="a-head b-group-text2 b-group-border3">证书查询</h4>
                <ul class="person">
               <form class="" method="post" action="" enctype="multipart/form-data" onsubmit="return check();" >
                证书编号:<br/>
				<input style="width:650px;height:30px;" type="text" id="tel" name="code" /><br/>
                <input type="submit" value="查询" class="submit"/>
              </form>

                </ul>

                <?php if(is_array($a)): $i = 0; $__LIST__ = $a;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><!--                     姓名：<?php echo ($vo["realname"]); ?><br>
                证书编号:<?php echo ($vo["ids"]); ?><br>
                证书期限:<?php echo ($vo["certifi_time"]); ?><br>
                出生日期:<?php echo ($vo["birth"]); ?><br>
课程:<?php echo ($vo["course"]); ?><br>
                注册时间:<?php echo ($vo["addtime"]); ?><br> -->


                <div class="cjcx_td">
          <div class="td">
            <br>
            <p class="sec"><span class="blue">姓名</span><span><?php echo ($vo["student_name"]); ?></span></p>
            <p class="sec"><span class="blue">证书编号</span><span><?php echo ($vo["certifi_number"]); ?></span></p>
            <p class="sec"><span class="blue">证书期限</span><span><?php echo ($vo["certifi_time"]); ?></span></p>
            <p class="sec"><span class="blue">所属机构</span><span><?php echo ($aname); ?></span></p>
            <p class="sec"><span class="blue">注册时间</span><span><?php echo (date('Y-m-d',$vo["addtime"])); ?></span></p>
