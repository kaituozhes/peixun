...
<div class="slides">
                            ...
                            <div class="">
                              ...
                              <div id="nav">
                                        ...
                                        <li role="presentation" class="u-cursor b-group-border1">
                                          <a href="<?php echo U('member/lecturer');?>" class="u-cursor active b-group-border1">讲师</a>
                                        </li>
      ...
      myNav[i].className="u-cursor active b-group-text1";
            ...
            <div class="a-right">
              <div class="b-group-border2">
				...
				<div class="cjcx_td">
					<div class="td">
            <form class="am-form tpl-form-line-form" enctype="multipart/form-data" method="post" onsubmit="return t()" action="<?php echo U('member/passedit');?>">
  ...
  if(flag == false){
    ...
    alert('新密码必须由 8-16位字母、数字、特殊符号线组成.');
