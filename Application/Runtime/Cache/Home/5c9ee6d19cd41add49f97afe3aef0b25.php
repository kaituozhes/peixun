        ...
        <div class="top-content">
            <div class="inner-bg">
                <div class="container">
                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                        	<div class="form-top">
                        		<div class="form-top-left">
                        			<h3>登录</h3>
                            		<p>如果没有账号,请<a href="<?php echo U('user/register');?>">注册</a></p>
                        		</div>
                            ...
                            <div class="form-bottom">
			                    <form role="form" action="<?php echo U('user/login');?>" method="post" class="login-form">
			                    	<div class="form-group">
			                    		<label class="sr-only" for="form-username">Username</label>
			                        	<input type="text" name="username" placeholder="账号" class="form-username form-control" id="form-username">
                                        <div style="float:right;"><a href="<?php echo U('user/useredit');?>">忘记密码</a></div>
			                        </div>
			                        <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 social-login" style="display:none;">
                        	<h3>...or login with:</h3>
