      ...
      myNav[i].className="u-cursor active b-group-text1";   
            ...
            <div class="a-right">
              <div class="b-group-border2">
				...
				<div class="cjcx_td">
					<div class="td">
            <form class="am-form tpl-form-line-form" enctype="multipart/form-data" method="post" action="<?php echo U('member/schoolrolledit');?>">
            <input type="hidden" name="table" value="student">
            <input type="hidden" name="jump" value="schoolroll">
            <input type="hidden" name="student_id" value="<?php echo ($arr["student_id"]); ?>">
						<p class="sec"><span class="blue">学生学号</span><span><?php echo ($arr["numeric"]); ?></span></p>
						<p class="sec"><span class="blue">姓名</span><span><?php echo ($arr["realname"]); ?></span></p>
						<p class="sec"><span class="blue">性别</span><span><?php if($arr[sex] == 1){echo '男';}else{echo '女';} ?></span></p>
						<p class="sec"><span class="blue">出生年月</span><span><?php echo ($arr["birth"]); ?></span></p>
						<p class="sec"><span class="blue">身份证号</span><span><?php echo ($arr["ids"]); ?></span></p>
						<p class="sec"><span class="blue">所在区域</span><span><input type="text" name="region" value="<?php echo ($arr["region"]); ?>" /></span></p>
						<p class="sec"><span class="blue">学历信息</span><span><?php echo ($arr["education"]); ?></span></p>
						<p class="sec"><span class="blue">注册时间</span><span><?php echo ($arr["zidingtime"]); ?></span></p>		
