...
<!--
	...
	<div class="tpl-content-wrapper">
            ...
            <ol class="am-breadcrumb">
                ...
                <li><a href="<?php echo U('agencym/lst');?>">培训机构管理员</a></li>
                <li class="am-active">培训机构管理员列表</li>
            </ol>
                        ...
                        <div class="am-u-sm-12 am-u-md-6">
                            <div class="am-btn-toolbar">
                                <div class="am-btn-group am-btn-group-xs">
                                    <button type="button" class="am-btn am-btn-default am-btn-success"><span class="am-icon-plus"></span><a href="<?php echo U('agencym/add');?>" style="color:white;">新增</a></button>
                                ...
                                <table class="am-table am-table-striped am-table-hover table-main">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="table-title">培训机构管理员</th>
                                            <th class="table-title">培训机构密码</th>
                                    ...
                                    <tbody>
                                    	<?php if(is_array($agencylst)): $i = 0; $__LIST__ = $agencylst;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                            <td><input type="checkbox"></td>
                                            <td><?php echo ($vo['username']); ?></td>
                                            <td>******</td>
                                            <td><?php if($vo["agency"] != 1): echo ($vo['agency']); else: ?>机构被删除<?php endif; ?></td>

                                            <td class="am-hide-sm-only"><?php echo (date("Y-m-d H:i:s",$vo['useraddtime'])); ?></td>
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
                                                        <a href="<?php echo U('agencym/edit',array('id'=>$vo['id']));?>" type="button" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span>编辑</a>
                                                        <a onclick="return confirm('确定删除？');" href="<?php echo U('agencym/del',array('id'=>$vo['id']));?>" type="button" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><span class="am-icon-trash-o"></span>删除</a>
                                                    </div>
                                                </div>
                                            </td>
