...
<!--
	...
	<div class="tpl-content-wrapper">
            ...
            <ol class="am-breadcrumb">
                ...
                <li><a href="<?php echo U('member/student');?>">学生管理</a></li>
            ...
            <div class="tpl-portlet-components">
                ...
                <div class="tpl-block">
                    <div class="am-g">
                        <div class="am-u-sm-12 am-u-md-6">
                            <div class="am-btn-toolbar">
                                <div class="am-btn-group am-btn-group-xs">
                                    <button type="button" class="am-btn am-btn-default am-btn-success"><span class="am-icon-plus"></span><a href="<?php echo U('member/student_add');?>" style="color:white;">新增</a></button>
                        ...
                        <div class="am-u-sm-12 am-u-md-3">
                        <form class="am-form tpl-form-line-form" enctype="multipart/form-data" method="post" action="<?php echo U('member/search');?>">
                            <div class="am-input-group am-input-group-sm">

                                <input type="text" name="search" placeholder="请输入学生身份证..." class="am-form-field">
                                    ...
                                    <thead>
                                        <tr>
                                           <!--  <th class="table-check"><input type="checkbox" class="tpl-table-fz-check"></th> -->
                                            ...
                                            <th class="table-title">出生年月</th>
                                            <!-- <th class="table-title">所在机构</th> -->
                                            <!-- <th class="table-title">课程名</th> -->
                                            <!-- <th class="table-title">用户组</th> -->
																						<th class="table-date am-hide-sm-only">注册时间</th>
                                            <th class="table-date am-hide-sm-only">后台录入时间</th>
                                            <th class="table-set">操作</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    	<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$mess): $mod = ($i % 2 );++$i;?><tr>

                                            <td><?php echo ($mess['realname']); ?> </td>
																						<td><?php if($mess['state'] == 1): ?><a style="color:#5eb95e;font-weight:bold;"><i><img src="/Public/images/ico.png" alt=""></i>已注册<?php else: ?>待注册<?php endif; ?></td>
                                            <td><?php echo ($mess['ids']); ?></td>
                                            <td><?php echo ($mess['numeric']); ?></td>
                                            <td>
                                                <?php switch($mess['sex']): case "1": ?>男<?php break;?>
                                                    <?php case "2": ?>女<?php break; endswitch;?>
                                            </td>
                                            <td><?php echo ($mess['birth']); ?></td>


                                            <!-- <td><?php echo ($mess['course']); ?></td> -->
                                            <!-- <td><?php echo ($mess['group_name']); ?></td> -->
																						<td class="am-hide-sm-only"><?php echo ($mess['zidingtime']); ?></td>
                                            <td class="am-hide-sm-only"><?php echo (date("Y-m-d H:i:s",$mess['addtime'])); ?></td>
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
                                                        <a href="<?php echo U('member/student_edit',array('id'=>$mess['student_id']));?>" type="button" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span>编辑</a>

                                                        <a href="<?php echo U('member/achievement',array('id'=>$mess['student_id']));?>" type="button" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span>成绩录入</a>

                                                        <a onclick="return confirm('确定删除该学生？');" href="<?php echo U('member/student_del',array('id'=>$mess['student_id']));?>" type="button" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><span class="am-icon-trash-o"></span>删除</a>
                                                    </div>
                                                </div>
                                            </td>
