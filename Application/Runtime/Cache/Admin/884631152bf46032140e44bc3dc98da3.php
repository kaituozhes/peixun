                ...
                <div class="portlet-title">
                    ...
                    <div class="tpl-portlet-input tpl-fz-ml">
                        <div class="portlet-input input-small input-inline">
													<form class="am-form tpl-form-line-form" enctype="multipart/form-data" method="post" action="<?php echo U('member/user');?>">
															<div class="am-input-group am-input-group-sm">

																	<input type="text" name="search" placeholder="会员编号" class="am-form-field">
                                ...
                                <table class="am-table am-table-striped am-table-hover table-main">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="table-title">会员密码</th>
                                            <!-- <th class="table-title">分数</th> -->
                                    ...
                                    <tbody>
                                    	<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td>******</td>
                                           <!--  <td><?php echo ($mess['fraction']); ?>分</td> -->
                                            <td><?php if($data[member_auth] == 2): ?>学员<?php else: ?>讲师<?php endif; ?></td>
                                            <!-- <td><?php echo ($mess['group_name']); ?></td> -->
                                            <td class="am-hide-sm-only"><?php echo (date("Y-m-d H:i:s",$data['member_addtime'])); ?></td>
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
                                                        <button type="button" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span><a href="<?php echo U('member/us_edit',array('id'=>$data['member_id']));?>">编辑</a></button>
                                                        <button onclick="return confirm('确定删除？');" type="button" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><span class="am-icon-trash-o"></span><a href="<?php echo U('member/us_del',array('id'=>$data['member_id'],'state'=>$data[member_auth],'numeric'=>$data[bianhao]));?>" style="color:#dd514c;">删除</a> </button>
                                                    </div>
                                                </div>
                                            </td>
