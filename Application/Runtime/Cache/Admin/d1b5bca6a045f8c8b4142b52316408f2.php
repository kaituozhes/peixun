...
<!-- 
	...
	<div class="tpl-content-wrapper">
            ...
            <ol class="am-breadcrumb">
                ...
                <li class="am-active">子栏目添加</li>
            </ol>
            <div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-code"></span> 子栏目添加
                    </div>
                        ...
                        <div class="tpl-form-body tpl-form-line">
                            <form class="am-form tpl-form-line-form" method="post" action="<?php echo U('category/insert');?>" enctype="multipart/form-data">
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">父栏目 <span class="tpl-form-line-small-title"></span></label>
                                    <div class="am-u-sm-9">
                                        <input type="text" disabled name="catename" class="tpl-form-input" value="<?php echo ($parent['catename']); ?>">
                                        <input type="hidden" name="pid" value="<?php echo ($parent['id']); ?>">
                                    </div>
                                </div>
								...
								<div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" name="cateinfo" placeholder="栏目描述">
                                    </div>
                                </div>
