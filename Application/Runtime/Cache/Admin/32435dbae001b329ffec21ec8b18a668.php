            ...
            <div class="am-g">
                <div class="tpl-form-body tpl-form-line">
                    <form class="am-form tpl-form-line-form" enctype="multipart/form-data" method="post" action="">
                        <input type="hidden" name="lecturer_id" value="<?php echo ($lectureres['lecturer_id']); ?>">


                       <div class="am-form-group">
                            <label for="user-name" class="am-u-sm-3 am-form-label">讲师编号 <span class="tpl-form-line-small-title"></span></label>
                            <div class="am-u-sm-9">
                                <input type="text" name="numbering" class="tpl-form-input" id="user-name" placeholder="讲师编号" onfocus="this.blur()" value="<?php echo ($lectureres["numbering"]); ?>"><p></p>
                            </div>
                        </div>
                        <!-- <div class="am-form-group">
                            <label for="user-name" class="am-u-sm-3 am-form-label">身份证 <span class="tpl-form-line-small-title"></span></label>
                            <div class="am-u-sm-9">
                                <input type="text" name="ids" class="tpl-form-input" id="user-name" placeholder="身份证" value="<?php echo ($data["ids"]); ?>">
                            </div>
                        </div> -->
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <input type="text" name="realname" class="tpl-form-input" id="user-name" placeholder="姓名" value="<?php echo ($lectureres["realname"]); ?>"><p></p>
                            </div>
                        </div>
                         <div class="am-form-group">
                            <label for="user-name" class="am-u-sm-3 am-form-label">手机号 <span class="tpl-form-line-small-title"></span></label>
                            <div class="am-u-sm-9">
                                <input type="text" name="tel" class="tpl-form-input" id="user-name" placeholder="电话" value="<?php echo ($lectureres["tel"]); ?>"><p></p>
                            </div>
                        </div>
                        <div class="am-form-group">
                            <label for="user-name" class="am-u-sm-3 am-form-label">邮箱 <span class="tpl-form-line-small-title"></span></label>
                            <div class="am-u-sm-9">
                                <input type="text" name="email" class="tpl-form-input" id="user-email" placeholder="123456@163.com" onfocus="this.blur()" value="<?php echo ($lectureres["email"]); ?>" ><p></p>
                            </div>
                        </div>
                        <div class="am-form-group">
                            <label for="user-name" class="am-u-sm-3 am-form-label">联系地址 <span class="tpl-form-line-small-title"></span></label>
                            <div class="am-u-sm-9">
                                <input type="text" name="address" class="tpl-form-input" id="user-name" placeholder="联系地址" value="<?php echo ($lectureres["address"]); ?>">
                            </div>
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <select name="sex" id="" class="tpl-form-input">
                                    ...
                                    <option value="1" <?php if($lectureres['sex'] == 1): ?>selected<?php endif; ?> >男</option>
                                    <option value="2" <?php if($lectureres['sex'] == 2): ?>selected<?php endif; ?> >女</option>
                                </select>
                            </div>
                        </div>
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <input type="text" onclick="laydate()" name="birth" class="tpl-form-input" id="user-name" placeholder="出生年月" value="<?php echo ($lectureres["birth"]); ?>">
                            </div>
                        </div>
                        <div class="am-form-group">
                            <label for="user-name" class="am-u-sm-3 am-form-label">工作年限 <span class="tpl-form-line-small-title"></span></label>
                            <div class="am-u-sm-9">
                                <input type="text" name="gongzuonianxian" class="tpl-form-input" id="user-name" placeholder="工作年限" value="<?php echo ($lectureres["gongzuonianxian"]); ?>"><p></p>
                            </div>
                        </div>
                        <div class="am-form-group">
                            <label for="user-name" class="am-u-sm-3 am-form-label">注册时间 <span class="tpl-form-line-small-title"></span></label>
                            <div class="am-u-sm-9">
                                <input type="text" onclick="laydate()" name="zidingtime" class="tpl-form-input" id="birth" placeholder="" value="<?php echo ($lectureres["zidingtime"]); ?>">
                            </div>
                        </div>
                        <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <!-- <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$auth): $mod = ($i % 2 );++$i;?><label class="am-checkbox-inline">
                                <input type="checkbox" name="subject[]" value="<?php echo ($auth['subject_id']); ?>"
                                    <?php if($group_data['is_array'] == 1): if(is_array($group_data['subject'])): $i = 0; $__LIST__ = $group_data['subject'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$th): $mod = ($i % 2 );++$i; if($auth['subject_id'] == $th): ?>checked<?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                    <?php else: ?>
                                        <?php if($auth['subject_id'] == $group_data['subject']): ?>checked<?php endif; endif; ?>> <?php echo ($auth['agencyrealname']); ?>--<?php echo ($auth['subject_name']); ?>
                            ...
                            <?php if(is_array($abb)): $i = 0; $__LIST__ = $abb;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$auth): $mod = ($i % 2 );++$i;?><label class="am-checkbox-inline">
                                <input type="checkbox" onclick="return false;" name="subject[]" value="<?php echo ($auth['subject_id']); ?>"
                                    <?php if($group_data['is_array'] == 1): if(is_array($group_data['subject'])): $i = 0; $__LIST__ = $group_data['subject'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$th): $mod = ($i % 2 );++$i; if($auth['subject_id'] == $th): ?>checked<?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                    <?php else: ?>
                                        <?php if($auth['subject_id'] == $group_data['subject']): ?>checked<?php endif; endif; ?>> <span style="color:#CCCCCC;"><?php echo ($auth['agencyrealname']); ?>--<?php echo ($auth['subject_name']); ?></span>
                            </label><?php endforeach; endif; else: echo "" ;endif; ?>
                        </div>
                    </div>
                        ...
                        <div class="am-u-sm-9">
                            <textarea class="" rows="5" name="description" id="user-intro" placeholder="<?php echo ($lectureres["description"]); ?>"><?php echo ($lectureres["description"]); ?></textarea>
                        </div>
                    </div>
