	...
	#page div span{background: #23abf0;color: #fff;border: 1px solid #23abf0;padding: 2px 12px;border-radius: 3px;display:inline-block;margin-right:5px;}
	 ...
	 <div class="tpl-content-wrapper">
            ...
            <ol class="am-breadcrumb">
                ...
                <li><a href="#">网站名称管理</a></li>
                <li class="am-active">网站名称</li>
            </ol>
                        ...
                        <div class="am-u-sm-12 am-u-md-6">
                            <div class="am-btn-toolbar">
                                <div class="am-btn-group am-btn-group-xs">
                                    <button type="button" class="am-btn am-btn-default am-btn-success"><span class="am-icon-plus"></span><a href="<?php echo U('link/basic_add');?>" style="color:white;">新增</a></button>
                                ...
                                <table class="am-table am-table-striped am-table-hover table-main">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="table-title">基本信息名称</th>
                                            <th class="table-title">基本信息代码</th>
                                            <th class="table-type">基本信息值</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo ($mess['basic_info']); ?></td>
                                            <td><?php echo ($mess['basic_key']); ?></td>
                                            <td>
												...
												<div class="am-modal am-modal-no-btn" tabindex="-1" id="doc-modal-<?php echo ($key); ?>">
												  <div class="am-modal-dialog">
												    <div class="am-modal-hd">基本信息值
												      <a href="javascript: void(0)" class="am-close am-close-spin" data-am-modal-close>&times;</a>
												    </div>
												    <div class="am-modal-bd">
												      	<?php echo ($mess['basic_value']); ?>
												    </div>
												  </div>
												</div>
											</td>
                                            ...
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
                                                        <button class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span><a href="<?php echo U('link/base_edit',array('id'=>$mess['bid']));?>">编辑</a> </button>
                                                        <button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><span class="am-icon-trash-o"></span><a href="<?php echo U('link/base_del',array('id'=>$mess['bid']));?>" style="color:#dd514c;"> 删除</a></button>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
