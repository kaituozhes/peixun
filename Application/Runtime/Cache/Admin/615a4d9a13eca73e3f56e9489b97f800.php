                        ...
                        <div class="tpl-form-body tpl-form-line">
                            <form class="am-form tpl-form-line-form" enctype="multipart/form-data" method="post" action="">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" name="member_name" class="tpl-form-input" id="user-name" placeholder="账号" value="<?php echo ($data['member_name']); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="password" name="member_password" class="tpl-form-input" id="user-name" placeholder="密码" value="<?php echo ($data['member_password']); ?>">
                                    </div>
                                </div>
