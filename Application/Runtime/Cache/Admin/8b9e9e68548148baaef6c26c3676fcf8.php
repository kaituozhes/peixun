            ...
            <div class="tpl-portlet-components">
                ...
                <div class="tpl-block">
                    <div class="am-g">
                        <div class="am-u-sm-12 am-u-md-6">
                            <div class="am-btn-toolbar">
                                <div class="am-btn-group am-btn-group-xs">
                                    <button type="button" class="am-btn am-btn-default am-btn-success"><span class="am-icon-plus"></span><a href="<?php echo U('member/agency_add');?>" style="color:white;">新增</a></button>
                                    <button type="button" class="am-btn am-btn-default am-btn-secondary"><span class="am-icon-save"></span><a href="<?php echo U('member/agency',array('id'=>1));?>"> 培训机构</a></button>
                                    <button type="button" class="am-btn am-btn-default am-btn-warning"><span class="am-icon-archive"></span><a href="<?php echo U('member/agency',array('id'=>2));?>"> 招生机构</a></button>
                        ...
                        <div class="am-u-sm-12 am-u-md-3">
                           <form class="am-form tpl-form-line-form" enctype="multipart/form-data" method="post" action="<?php echo U('member/agencysearch');?>">
                            <div class="am-input-group am-input-group-sm">

                                <input type="text" name="search" placeholder="请输入机构编号..." class="am-form-field">
                                ...
                                <table class="am-table am-table-striped am-table-hover table-main">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="table-title">机构编号</th>
                                            <th class="table-title">注册时间</th>
                                            <th class="table-title">营业执照编号</th>
                                            <th class="table-title">机构类别</th>
                                    ...
                                    <tbody>
                                    	 <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$mess): $mod = ($i % 2 );++$i;?><tr>
                                            <td><?php echo ($mess['agencyrealname']); ?></td>
                                            <td><?php echo ($mess['agencynumber']); ?></td>
                                            <td><?php echo ($mess['regtime']); ?></td>
                                             <td><?php echo ($mess['bln']); ?></td>
                                                <?php if($mess['agencyclass'] == 1): ?><td>培训机构</td><?php else: ?><td>招生机构</td><?php endif; ?>

                                            <td class="am-hide-sm-only"><?php echo (date("Y-m-d H:i:s",$mess['addtime'])); ?></td>
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
                                                        <a href="<?php echo U('member/agency_edit',array('id'=>$mess['agency_id']));?>" type="button" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span>编辑</a>
                                                        <a href="<?php echo U('del/agencydel',array('id'=>$mess['agency_id'],'table'=>'agency','jump'=>'agency'));?>" onclick="return confirm('确定删除该机构？');" type="button" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><span class="am-icon-trash-o"></span>删除</a>
                                                    </div>
                                                </div>
                                            </td>
