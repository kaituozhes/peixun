...
<div class="tpl-content-wrapper">
    ...
    <ol class="am-breadcrumb">
        ...
        <li><a href="<?php echo U('member/student');?>">学员信息管理</a></li>
        ...
        <div class="tpl-block">
            ...
            <div class="am-g">
                <div class="tpl-form-body tpl-form-line">
                    <form class="am-form tpl-form-line-form" enctype="multipart/form-data" method="post" action="<?php echo U('member/student_adds');?>">
...
<script type="text/javascript">
    ...
    $(function(){
      ...
      $('#ids').blur(function(){
        ids = $(this).val();
        $.get("<?php echo U('member/ajax_get_student');?>",{ids:ids},function(msg){
          if(msg){
