                            ...
                            <div class="am-btn-toolbar">
                                <div class="am-btn-group am-btn-group-xs hs_diy">
                                    <button type="button" class="am-btn am-btn-default am-btn-success">
                                    	...
                                    	<a href="<?php echo U('category/authcate_add');?>">新增</a>
                                    </button>
                                ...
                                <table class="am-table am-table-striped am-table-hover table-main">
                                    ...
                                    <tbody>
                                    	<?php if(is_array($list)): $key = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($key % 2 );++$key;?><tr>
                                            ...
                                            <td style="text-indent:<?php echo ($data['level']*30); ?>px"><?php echo ($data['authcate_name']); ?></td>
                                            <td>
                                            ...
                                            <td class="am-hide-sm-only">
                                                ...
                                                <div class="am-modal am-modal-no-btn" tabindex="-1" id="doc-modal-<?php echo ($key); ?>6">
                                                  <div class="am-modal-dialog">
                                                    <div class="am-modal-hd">栏目图片
                                                      <a href="javascript: void(0)" class="am-close am-close-spin" data-am-modal-close>&times;</a>
                                                    </div>
                                                    <div class="am-modal-bd">
                                                        <?php if($data['cateimg']): ?><img src="/Public/<?php echo ($data['cateimg']); ?>" width="100px" height="50px">
                                                        <?php else: ?>
                                                            无<?php endif; ?>
                                                    </div>
                                                  </div>
                                            ...
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
                                                        <a href="<?php echo U('category/authcate_edit',array('id'=>$data['id']));?>" type="button" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span>编辑</a>
                                                        <a href="<?php echo U('category/authcate_add_son',array('id'=>$data['id']));?>" type="button" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span>添加子类</a>
                                                        <a href="<?php echo U('category/authcate_del',array('id'=>$data['id']));?>" type="button" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><span class="am-icon-trash-o"></span>删除</a>
                                                    </div>
                                                </div>
                                            </td>
