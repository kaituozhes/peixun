...
<div class="tpl-content-wrapper">
    ...
    <ol class="am-breadcrumb">
        ...
        <li><a href="<?php echo U('subject/lst');?>">科目管理</a></li>
        <li class="am-active">科目修改</li>
    </ol>
        ...
        <div class="tpl-block">
            ...
            <div class="am-g">
                <div class="tpl-form-body tpl-form-line">
                    <form class="am-form tpl-form-line-form" enctype="multipart/form-data" method="post" action="<?php echo U('subject/edit');?>">
                        <input type="hidden" name='subject_id' value="<?php echo ($data['subject_id']); ?>">

                        <div class="am-form-group">
                            <label for="user-name" class="am-u-sm-3 am-form-label">科目 <span class="tpl-form-line-small-title"></span></label>
                            <div class="am-u-sm-9">
                                <input type="text" name="subject_name" class="tpl-form-input" id="user-name" placeholder="科目" value="<?php echo ($data['subject_name']); ?>"><p></p>
                            </div>
                        </div>


                       <!--  <div class="am-form-group">
                           <label for="user-name" class="am-u-sm-3 am-form-label">级别规则<span class="tpl-form-line-small-title"></span></label>
                           <div class="am-u-sm-9">
                           <div style="width:500px;height:200px;float:left;font-size:16px;">

                               只在项目为可选时有效，每行一个级别，等号前面为级别索引(建议用数字)，后面为内容，例如:<br>
                               1=初级<br>
                               2=中级<br>
                               3=高级<br>
                           </div>

                           <textarea style="width:200px;height:200px;border:1px solid #c2cad8;float:left;" rows="4" cols="50" name="rules"><?php echo ($level); ?></textarea>
                       </div>
                       </div> -->
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <select name="agency_id" id="">
                                      <!-- <option value="<?php echo ($agency["agency_id"]); ?>"><?php echo ($agency["agencyrealname"]); ?></option> -->
                                    <?php if(is_array($agencyco)): $i = 0; $__LIST__ = $agencyco;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["agency_id"]); ?>" <?php if($vo[agency_id] == $agency[agency_id]): ?>selected<?php else: endif; ?>
                                        ><?php echo ($vo["agencyrealname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
...
<script type="text/javascript">
    $(function(){
        var realname = false;
        $('input[name=subject_name]').blur(function(){
            var na = $(this).val();
            if(na.length == ""){
                $(this).next().html('*科目不可为空');
