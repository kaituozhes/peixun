        ...
        <div class="tpl-block">
            ...
            <div class="am-g">
                <div class="tpl-form-body tpl-form-line">
                    <form class="am-form tpl-form-line-form" enctype="multipart/form-data" method="post" action="<?php echo U('subject/subjectadd');?>">
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <input type="text" name="subject_name" class="tpl-form-input" id="user-name" placeholder="科目" value=""><p></p>
                            </div>
                        </div>
                        ...
                        <!-- <div class="am-form-group">
                            ...
                            <textarea style="width:200px;height:200px;border:1px solid #c2cad8;float:left;" rows="4" cols="50" name="rules"></textarea>
                        </div>
                        </div>-->
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <select name="agency_id" id="">
                                    <?php if(is_array($jigous)): $i = 0; $__LIST__ = $jigous;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo['agency_id']); ?>"><?php echo ($vo['agencyrealname']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                            </div>
                        </div>
