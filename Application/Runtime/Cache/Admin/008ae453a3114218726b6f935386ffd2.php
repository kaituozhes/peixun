                ...
                <div class="tpl-block">
                    ...
                    <div class="am-g">
                        <div class="tpl-form-body tpl-form-line">
                            <form class="am-form tpl-form-line-form" method="post" action="<?php echo U('gear/update');?>" enctype="multipart/form-data">
                            	<input type="hidden" name="id" value="<?php echo ($data['id']); ?>">
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">跳转链接 <span class="tpl-form-line-small-title">link</span></label>
                                    <div class="am-u-sm-9">
                                        <input type="text" name="jump_link" class="tpl-form-input" id="user-name" placeholder="请输入跳转链接" value="<?php echo ($data['jump_link']); ?>">
                                        <small>跳转链接必须以http://或者https://开头</small>
                                    </div>
                                </div>

                                <div class="am-form-group">
                                    <label class="am-u-sm-3 am-form-label">轮播排序 <span class="tpl-form-line-small-title">sort</span></label>
                                    <div class="am-u-sm-9">
                                        <input type="text" name="sort" placeholder="轮播排序" value="<?php echo ($data['sort']); ?>">
                                        <small>轮播排序默认从小到大</small>
                                    </div>
                                </div>
                                    ...
                                    <div class="am-u-sm-9">
                                        <div class="am-form-group am-form-file">
                                            <div class="tpl-form-file-img">
                                                <img src="/Public/<?php echo ($data['image']); ?>" alt="">
                                            </div>
