                        ...
                        <div class="tpl-form-body tpl-form-line">
                            <form class="am-form tpl-form-line-form" method="post" action="">
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" name="basic_info" class="tpl-form-input" id="user-name" placeholder="请输入基本信息名称">
                                    </div>
                                </div>                               
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" name="basic_key" placeholder="输入基本信息代码">
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" name="basic_value" placeholder="输入基本信息值">
                                    </div>
                                </div>
