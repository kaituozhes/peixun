        ...
        <div class="tpl-block">
            ...
            <div class="am-g">
                <div class="tpl-form-body tpl-form-line">
                    <form class="am-form tpl-form-line-form" enctype="multipart/form-data" method="post" action="<?php echo U('member/student_edits');?>">
                        <input type="hidden" name="table" value="student">
                        <input type="hidden" name="jump" value="student">
                        <input type="hidden" name="auth" value="2">
                        <input type="hidden" name="student_id" value="<?php echo ($d["student_id"]); ?>">

                        <div class="am-form-group">
                            <label for="user-name" class="am-u-sm-3 am-form-label">姓名 <span class="tpl-form-line-small-title"></span></label>
                            <div class="am-u-sm-9">
                                <input type="text" name="realname" class="tpl-form-input" id="user-name" placeholder="姓名" value="<?php echo ($d["realname"]); ?>">
                            </div>
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <input type="text" name="ids" class="tpl-form-input" id="user-name" placeholder="身份证" value="<?php echo ($d["ids"]); ?>">
                            </div>
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <input type="text" name="numeric" class="tpl-form-input" id="user-name" placeholder="学号" value="<?php echo ($d["numeric"]); ?>">
                            </div>
                        </div>
                       ...
                       <div class="am-form-group">
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <input type="text" onclick="laydate()" name="birth" class="tpl-form-input" id="user-name" placeholder="出生年月" value="<?php echo ($d["birth"]); ?>">
                            </div>
                        </div>
                        <div class="am-form-group">
                            <label for="user-name" class="am-u-sm-3 am-form-label">学历信息 <span class="tpl-form-line-small-title"></span></label>
                            <div class="am-u-sm-9">
                                <input type="text" name="education" class="tpl-form-input" id="user-name" placeholder="学历信息" value="<?php echo ($d["education"]); ?>">
                            </div>
                        </div>
                        <div class="am-form-group">
                            <label for="user-name" class="am-u-sm-3 am-form-label">所在区域<span class="tpl-form-line-small-title"></span></label>
                            <div class="am-u-sm-9">
                                <input type="text" name="region" class="tpl-form-input" id="user-name" placeholder="所在区域" value="<?php echo ($d["region"]); ?>">
                            </div>
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$auth): $mod = ($i % 2 );++$i;?><label class="am-checkbox-inline">
                                                        <input type="checkbox" name="agency[]" value="<?php echo ($auth['agency_id']); ?>" 
                                                            <?php if($group_data['is_array'] == 1): if(is_array($group_data['agency'])): $i = 0; $__LIST__ = $group_data['agency'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$th): $mod = ($i % 2 );++$i; if($auth['agency_id'] == $th): ?>checked<?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                                            <?php else: ?>
                                                                <?php if($auth['agency_id'] == $group_data['agency']): ?>checked<?php endif; endif; ?>> <?php echo ($auth['agencyrealname']); ?>
...
<!--                         <div class="am-form-group">
    <label for="user-name" class="am-u-sm-3 am-form-label">所在机构 <span class="tpl-form-line-small-title"></span></label>
    <div class="am-u-sm-9">
        <?php if(is_array($agency)): $i = 0; $__LIST__ = $agency;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><td><input type="checkbox" checked="" name="" value="<?php echo ($vo['agency_id']); ?>"/><?php echo ($vo['agencyrealname']); ?></td><?php endforeach; endif; else: echo "" ;endif; ?>
    </div>
</div> -->
...
<!--                         <div class="am-form-group">
    <label for="user-name" class="am-u-sm-3 am-form-label">课程名 <span class="tpl-form-line-small-title"></span></label>
    <div class="am-u-sm-9">
        <input type="text" name="course" class="tpl-form-input" id="user-name" placeholder="姓名" value="<?php echo ($d["course"]); ?>">
    </div>
</div> -->
                        <div class="am-form-group">
