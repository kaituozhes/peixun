                        ...
                        <div class="am-u-sm-12 am-u-md-6">
                            <div class="am-btn-toolbar">
                                <div class="am-btn-group am-btn-group-xs">
                                    <button type="button" class="am-btn am-btn-default am-btn-success"><span class="am-icon-plus"></span><a href="<?php echo U('member/lecturer_add');?>" style="color:white;">新增</a></button>
...
<button type="button" class="am-btn am-btn-default am-btn-danger"><span class="am-icon-trash-o"></span> 删除</button> -->
                        ...
                        <div class="am-u-sm-12 am-u-md-3">
                            <form class="am-form tpl-form-line-form" enctype="multipart/form-data" method="post" action="<?php echo U('member/lecturersearch');?>">
                            <div class="am-input-group am-input-group-sm">

                                <input type="text" name="search" placeholder="请输入讲师编号..." class="am-form-field">
                                ...
                                <table class="am-table am-table-striped am-table-hover table-main">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="table-date am-hide-sm-only">信息录入时间</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo ($mess['numbering']); ?></td>
																						<td><?php if($mess['state'] == 1): ?><a style="color:#4db14d;font-weight:bold;"><i><img src="/Public/images/ico.png" alt=""></i>已注册</a><?php else: ?>待注册<?php endif; ?></td>
                                            ...
                                            <td><?php echo ($mess['tel']); ?></td>
																						<td><?php echo ($mess['zidingtime']); ?></td>
                                            <td class="am-hide-sm-only"><?php echo (date("Y-m-d H:i:s",$mess['addtime'])); ?></td>
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
                                                        <a href="<?php echo U('member/lecturer_edit',array('id'=>$mess['lecturer_id']));?>" type="button" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span>编辑</a>
                                                        <a onclick="return confirm('确定删除该讲师？');" href="<?php echo U('member/common_del',array('id'=>$mess['lecturer_id'],'table'=>'lecturer','jump'=>'lecturer'));?>" type="button" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><span class="am-icon-trash-o"></span>删除 </a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
