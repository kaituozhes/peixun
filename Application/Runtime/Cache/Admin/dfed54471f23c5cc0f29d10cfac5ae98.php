                ...
                <div class="tpl-block">
                    ...
                    <div class="am-g">
                        <div class="tpl-form-body tpl-form-line">
                            <form class="am-form tpl-form-line-form" method="post" action="<?php echo U('category/update');?>" enctype="multipart/form-data">
                            	<input type="hidden" name="id" value="<?php echo ($data['id']); ?>">
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">栏目名 <span class="tpl-form-line-small-title"></span></label>
                                    <div class="am-u-sm-9">
                                        <input type="text" name="catename" class="tpl-form-input" id="user-name" placeholder="请输入栏目名" value="<?php echo ($data['catename']); ?>">
                                    </div>
                                </div>
								...
								<div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" name="enname" class="tpl-form-input" id="user-name" placeholder="请输入栏目英文名" value="<?php echo ($data['enname']); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" name="controller" id="user-weibo" placeholder="栏目控制器" value="<?php echo ($data['controller']); ?>">
                                        <div></div>
                                    </div>
                                </div>
								...
								<div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" name="function" id="user-weibo" placeholder="栏目方法" value="<?php echo ($data['function']); ?>">
                                        <div></div>
                                    </div>
                                </div>
								...
								<div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" name="cateinfo" placeholder="输入SEO网站描述" value="<?php echo ($data['cateinfo']); ?>">
                                    </div>
                                </div>
								
								<div class="am-form-group">
                                    <label class="am-u-sm-3 am-form-label">SEO标题 <span class="tpl-form-line-small-title">title</span></label>
                                    <div class="am-u-sm-9">
                                        <input type="text" name="title" placeholder="输入SEO标题" value="<?php echo ($data['title']); ?>">
                                    </div>
                                </div>

                                <div class="am-form-group">
                                    <label class="am-u-sm-3 am-form-label">SEO关键字 <span class="tpl-form-line-small-title">keywords</span></label>
                                    <div class="am-u-sm-9">
                                        <input type="text" name="keywords" placeholder="输入SEO关键字" value="<?php echo ($data['keywords']); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    <label class="am-u-sm-3 am-form-label">SEO网站描述 <span class="tpl-form-line-small-title">description</span></label>
                                    <div class="am-u-sm-9">
                                        <input type="text" name="description" placeholder="输入SEO网站描述" value="<?php echo ($data['description']); ?>">
                                    </div>
                                </div>
                                    ...
                                    <div class="am-u-sm-9">
                                        <div class="am-form-group am-form-file">
                                            <div class="tpl-form-file-img">
                                            	<?php if($data['cateimg']): ?><img src="/Public/<?php echo ($data['cateimg']); ?>" width="200px" alt=""><?php endif; ?>
                                            </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" name="sort" id="user-weibo" placeholder="栏目排序 不设置的情况下默认以ID排序" value="<?php echo ($data['sort']); ?>">
                                        <div></div>
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <div class="tpl-switch">
                                            <input type="checkbox" name="hidden" class="ios-switch bigswitch tpl-switch-btn" value="1"  <?php if($data['hidden'] == 1): ?>checked<?php endif; ?> />
                                ...
                                <div class="am-form-group">
                                	 <label for="user-intro" class="am-u-sm-3 am-form-label">栏目定位</label>
                                	 <div class="am-u-sm-9">
									      <label class="am-radio-inline">
									        <input type="radio"  value="1" name="position" <?php if($data['position'] == 1): ?>checked<?php endif; ?>>顶部
									      </label>
									      <label class="am-radio-inline">
									        <input type="radio" value="2" name="position" <?php if($data['position'] == 2): ?>checked<?php endif; ?>>底部
									      </label>
								    </div>
								</div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <input type="hidden" name="content" value="<?php echo ($data['content']); ?>">
                                </div>
...
<script src="/Public/web/home/js/changeeditor.js"></script>
<script type="text/javascript">
var info = $('input[name=content]').val();
