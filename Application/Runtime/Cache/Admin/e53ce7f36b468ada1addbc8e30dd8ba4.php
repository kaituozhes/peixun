        ...
        <div class="tpl-block">
            ...
            <div class="am-g">
                <div class="tpl-form-body tpl-form-line">
                    <form class="am-form tpl-form-line-form" enctype="multipart/form-data" method="post" action="<?php echo U('member/certifi_edit');?>">
                    <input type="hidden" name="table" value="certifi">
                    <input type="hidden" name="jump" value="certifi">
                        <input type="hidden" name='certifi_id' value="<?php echo ($data['certifi_id']); ?>">
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <input type="text" name="ids" class="tpl-form-input" id="user-name" onfocus="this.blur()" placeholder="证书编号" value="<?php echo ($data['ids']); ?>"><P></P>
                            </div>
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <input type="text" name="certifi_number" class="tpl-form-input" id="user-name" placeholder="证书编号" value="<?php echo ($data['certifi_number']); ?>"><P></P>
                            </div>
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <input type="text" name="student_name" class="tpl-form-input" id="user-name" placeholder="学生姓名" value="<?php echo ($data['student_name']); ?>"><P></P>
                            </div>
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <input type="text" name="certifi_time" class="tpl-form-input" id="user-name" placeholder="证书期限" value="<?php echo ($data['certifi_time']); ?>">
                            </div>
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <!-- <select name="agency" id="">
                                     <?php if(is_array($agency_datas)): $i = 0; $__LIST__ = $agency_datas;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["agency_id"]); ?>" <?php if($vo[agency_id] == $data['agency_id']): ?>selected<?php else: endif; ?>
