                        ...
                        <div class="tpl-form-body tpl-form-line">
                            <form class="am-form tpl-form-line-form" method="post" action="" enctype="multipart/form-data">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" name="authcate_name" class="tpl-form-input" id="user-name" placeholder="请输入标题文字" value="<?php echo ($data['authcate_name']); ?>">
                                    </div>
                                </div>
								...
								<div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" name="enname" class="tpl-form-input" id="user-name" placeholder="请输入标题文字" value="<?php echo ($data['enname']); ?>">
                                    </div>
                                </div>
