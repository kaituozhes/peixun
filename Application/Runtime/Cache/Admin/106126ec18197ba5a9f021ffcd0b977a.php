...
<!--
	...
	<div class="tpl-content-wrapper">
            ...
            <ol class="am-breadcrumb">
                ...
                <li><a href="<?php echo U('member/student');?>">学生信息管理</a></li>
                <li class="am-active">学员成绩列表</li>
            </ol>
                        ...
                        <div class="am-u-sm-12">
                            <form class="am-form">
                                <table class="am-table am-table-striped am-table-hover table-main">
                                    ...
                                    <tbody>
																				<?php if(!is_null($subjectres[0]['agency'])){ ?>
                                            <?php if(is_array($subjectres)): $i = 0; $__LIST__ = $subjectres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                            <td><input type="checkbox"></td>
                                            <td><?php echo ($vo["subject_name"]); ?></td>
                                            <td><?php echo ($data['numeric']); ?></td>
                                            <td><?php echo ($vo["agency"]); ?></td>
                                            <td><?php echo ($data['realname']); ?></td>
                                            <td>
                                            <?php if($vo["stage"] == 1): ?>课程学习
                                            <?php elseif($vo["stage"] == 2): ?>考试准备
                                            <?php elseif($vo["stage"] == 3): ?> 考试完成 | <?php echo ($vo['fen']); ?>
                                            <?php else: ?>无进度<?php endif; ?>
                                            </td>
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
                                                        <button type="button" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span><a href="<?php echo U('member/achievement_edit',array('student_id'=>$data['student_id'],'subject_id'=>$vo[subject_id]));?>">编辑</a></button>
