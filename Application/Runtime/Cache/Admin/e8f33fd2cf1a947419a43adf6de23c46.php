...
<!-- 
	 ...
	 <div class="tpl-content-wrapper">
            ...
            <ol class="am-breadcrumb">
                ...
                <li class="am-active">网站基本信息添加</li>
            </ol>
                        ...
                        <div class="tpl-form-body tpl-form-line">
                            <form class="am-form tpl-form-line-form" method="post" action="">
                                ...
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">基本信息名称 <span class="tpl-form-line-small-title"></span></label>
                                    <div class="am-u-sm-9">
                                        <input type="text" name="basic_info" class="tpl-form-input" id="user-name" placeholder="请输入基本信息名称" value="<?php echo ($data['basic_info']); ?>">
                                    </div>
                                </div>                               

                                <div class="am-form-group">
                                    <label class="am-u-sm-3 am-form-label">基本信息代码 <span class="tpl-form-line-small-title"></span></label>
                                    <div class="am-u-sm-9">
                                        <input type="text" name="basic_key" placeholder="输入基本信息代码" value="<?php echo ($data['basic_key']); ?>">
                                    </div>
                                </div>

                                <div class="am-form-group">
                                    <label class="am-u-sm-3 am-form-label">基本信息值 <span class="tpl-form-line-small-title"></span></label>
                                    <div class="am-u-sm-9">
                                        <input type="text" name="basic_value" placeholder="输入基本信息值" value="<?php echo ($data['basic_value']); ?>">
                                    </div>
                                </div>
