        ...
        <div class="tpl-block">
            ...
            <div class="am-g">
                <div class="tpl-form-body tpl-form-line">
                    <form class="am-form tpl-form-line-form" enctype="multipart/form-data" method="post" action="<?php echo U('member/agency_add');?>">
...
<!-- <div class="am-form-group">
    ...
    <div class="am-u-sm-9">
        <select name="auth" id="">
            ...
            <?php if(is_array($group_data)): $i = 0; $__LIST__ = $group_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$group): $mod = ($i % 2 );++$i;?><option value="<?php echo ($group['group_id']); ?>"><?php echo ($group['group_name']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
        </select>
    </div>
</div> -->
