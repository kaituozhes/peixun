...
<div class="tpl-content-wrapper">
            ...
            <ol class="am-breadcrumb">
                ...
                <li><a href="<?php echo U('agencym/lst');?>">机构管理员</a></li>
                <li class="am-active">机构管理员修改</li>
            </ol>
                        ...
                        <div class="tpl-form-body tpl-form-line">
                            <form class="am-form tpl-form-line-form" enctype="multipart/form-data" method="post" action="">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" name="username" class="tpl-form-input" id="user-name" placeholder="账号" value="<?php echo ($data['username']); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <select name="agency_id" id="">
                                            ...
                                            <?php if(is_array($agency)): $i = 0; $__LIST__ = $agency;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["agency_id"]); ?>" <?php if($vo[agency_id] == $data[agency_id]): ?>selected<?php else: endif; ?>
