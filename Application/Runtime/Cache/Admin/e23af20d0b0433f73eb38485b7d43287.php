                        ...
                        <div class="am-u-sm-12 am-u-md-6">
                            <div class="am-btn-toolbar">
                                <div class="am-btn-group am-btn-group-xs">
                                    <button type="button" class="am-btn am-btn-default am-btn-success"><span class="am-icon-plus"></span><a href="<?php echo U('group/add');?>" style="color:white;">新增</a></button>
                                ...
                                <table class="am-table am-table-striped am-table-hover table-main">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="table-title">权限列表</th>
                                            <th class="table-date am-hide-sm-only">添加时间</th>
                                            <th class="table-set">操作</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    	<!-- <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$mess): $mod = ($i % 2 );++$i;?>-->
                                        <tr>
                                            <td><input type="checkbox"></td>
                                            <td><a href="#"><?php echo ($mess['group_name']); ?></a></td>
                                            <td><?php echo ($mess['group_list']); ?></td>
                                            <td class="am-hide-sm-only"><?php echo (date("Y-m-d H:i:s",$mess['entrytime'])); ?></td>
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
                                                        <button type="button" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span><a href="<?php echo U('group/edit',array('id'=>$mess['group_id']));?>">编辑</a></button>
                                                        <button type="button" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><span class="am-icon-trash-o"></span><a href="<?php echo U('group/del',array('id'=>$mess['group_id']));?>" style="color:#dd514c;">删除</a> </button>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
