	...
	#page div span{background: #23abf0;color: #fff;border: 1px solid #23abf0;padding: 2px 12px;border-radius: 3px;display:inline-block;margin-right:5px;}
	 ...
	 <div class="tpl-content-wrapper">
            ...
            <ol class="am-breadcrumb">
                ...
                <li><a href="#">网站附加信息管理</a></li>
                <li class="am-active">网站附加信息列表</li>
            </ol>
                        ...
                        <div class="am-u-sm-12 am-u-md-6">
                            <div class="am-btn-toolbar">
                                <div class="am-btn-group am-btn-group-xs">
                                    <button type="button" class="am-btn am-btn-default am-btn-success"><span class="am-icon-plus"></span><a href="<?php echo U('link/fujia_add');?>" style="color:white;">新增</a></button>
                                ...
                                <table class="am-table am-table-striped am-table-hover table-main">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="table-title">附加信息名称</th>
                                            <th class="table-title">附加信息代码</th>
                                            <th class="table-type">附加信息值</th>
                                            <th class="table-type">定位</th>
                                            <th class="table-set">操作</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    	<!-- <?php if(is_array($message)): $key = 0; $__LIST__ = $message;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$mess): $mod = ($key % 2 );++$key;?>-->
                                        <tr>
                                            <td><input type="checkbox"></td>
                                            <td><?php echo ($mess['fujia_info']); ?></td>
                                            <td><?php echo ($mess['fujia_key']); ?></td>
                                            <td>
                                            	<button type="button" class="am-btn am-btn-success" style="background:#5EB95E;" data-am-modal="{target:'#doc-modal-<?php echo ($key); ?>', closeViaDimmer: 0, width: 400, height: 260}">
												  查看
												</button>
												<div class="am-modal am-modal-no-btn" tabindex="-1" id="doc-modal-<?php echo ($key); ?>">
												  <div class="am-modal-dialog">
												    <div class="am-modal-hd">附加信息值
												      <a href="javascript: void(0)" class="am-close am-close-spin" data-am-modal-close>&times;</a>
												    </div>
												    <div class="am-modal-bd">
												      	<img src="/Public/<?php echo ($mess['fujia_value']); ?>" width="200px" alt="">
												    </div>
												  </div>
												</div>
											</td>
                                            <td class="am-hide-sm-only">
												<?php switch($mess['position']): case "1": ?>顶部<?php break;?>
													<?php case "2": ?>底部<?php break; endswitch;?>
                                            </td>
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
                                                        <a href="<?php echo U('link/fujia_edit',array('id'=>$mess['fujia_id']));?>" type="button" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span>编辑</a>
                                                        <a href="<?php echo U('link/fujia_del',array('id'=>$mess['fujia_id']));?>" type="button" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><span class="am-icon-trash-o"></span> 删除</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
