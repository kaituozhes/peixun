                        ...
                        <div class="am-u-sm-12 am-u-md-6">
                            <div class="am-btn-toolbar">
                                <div class="am-btn-group am-btn-group-xs">
                                    <button type="button" class="am-btn am-btn-default am-btn-success"><span class="am-icon-plus"></span><a href="<?php echo U('member/certifi_add');?>" style="color:white;">新增</a></button>
...
<button type="button" class="am-btn am-btn-default am-btn-danger"><span class="am-icon-trash-o"></span> 删除</button> -->
                        ...
                        <div class="am-u-sm-12 am-u-md-3">
                            <form class="am-form tpl-form-line-form" enctype="multipart/form-data" method="post" action="<?php echo U('member/certifisearch');?>">
                            <div class="am-input-group am-input-group-sm">

                                <input type="text" name="search" placeholder="请输入证书编号..." class="am-form-field">
                                ...
                                <table class="am-table am-table-striped am-table-hover table-main">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="table-title">证书编号</th>
                                            <th class="table-title">身份证</th>
                                            <th class="table-title">学生姓名</th>
                                            <th class="table-title">证书期限</th>
                                    ...
                                    <tbody>
                                    	<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$mess): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td><?php echo ($mess['certifi_number']); ?></td>
                                            <td><?php echo ($mess['ids']); ?></td>
                                            <td><?php echo ($mess['student_name']); ?></td>
                                            <td><?php echo ($mess['certifi_time']); ?></td>
                                            ...
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
                                                        <a href="<?php echo U('member/certifi_edit',array('id'=>$mess['certifi_id']));?>" type="button" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span>编辑</a>
                                                        <a onclick="return confirm('确定删除该学生证书？');" href="<?php echo U('member/common_del',array('id'=>$mess['certifi_id'],'table'=>'certifi','jump'=>'certifi'));?>" type="button" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><span class="am-icon-trash-o"></span>删除</a>
                                                    </div>
                                                </div>
                                            </td>
