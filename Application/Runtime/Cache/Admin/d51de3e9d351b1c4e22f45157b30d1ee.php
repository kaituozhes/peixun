            ...
            <div class="tpl-portlet-components">
                ...
                <div class="tpl-block">
                    <div class="am-g">
                        <div class="am-u-sm-12 am-u-md-6">
                            <div class="am-btn-toolbar">
                                <div class="am-btn-group am-btn-group-xs">
                                    <button type="button" class="am-btn am-btn-default am-btn-success"><span class="am-icon-plus"></span><a href="<?php echo U('subject/add');?>" style="color:white;">新增</a></button>
                        ...
                        <div class="am-u-sm-12 am-u-md-3">
                            <form class="am-form tpl-form-line-form" enctype="multipart/form-data" method="post" action="<?php echo U('subject/search');?>">
                            <div class="am-input-group am-input-group-sm">

                                <input type="text" name="search" placeholder="请输入正确的科目名称..." class="am-form-field">
                                ...
                                <table class="am-table am-table-striped am-table-hover table-main">
                                    <thead>
                                        <tr>
                                            ...
                                            <!-- <th class="table-title">科目ID</th> -->
                                            <th class="table-title">科目类</th>
                                            <th class="table-title">所属机构</th>
                                            <th class="table-date am-hide-sm-only">注册时间</th>
                                            <th class="table-set">操作</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    	<?php if(is_array($sub)): $i = 0; $__LIST__ = $sub;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$mess): $mod = ($i % 2 );++$i;?><tr>
                                            <!-- <td><input type="checkbox"></td> -->
                                            <!-- <td><?php echo ($mess['subject_id']); ?></td> -->
                                            <td><?php echo ($mess['subject_name']); ?></td>
                                            <td><?php echo ($mess['agencyname']); ?></td>
                                            <td class="am-hide-sm-only"><?php echo (date("Y-m-d H:i:s",$mess['addtime'])); ?></td>
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
                                                        <a href="<?php echo U('subject/edit',array('id'=>$mess['subject_id']));?>" type="button" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span>编辑</a>
                                                        <a href="<?php echo U('subject/common_del',array('id'=>$mess['subject_id'],'table'=>'subject','jump'=>'lst'));?>" onclick="return confirm('确定删除该科目？');" type="button" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><span class="am-icon-trash-o"></span>删除</a>
                                                    </div>
                                                </div>
                                            </td>
